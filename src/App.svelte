...
const handelLink = (e) => {
	...
	setTimeout(() => {
		animateScroll.scrollTo({element: e, offset: -80})
		onReload();
	}, 10);
}
...
function onReload(params) {
	let card = document.querySelector('#banners .preview:first-child');
	let card0 = document.querySelector('#banners .preview:first-child .w3-card-0');
	let more = document.querySelector('#banners .preview:first-child .w3-card-0 .more');
	let img = document.querySelector('#banners .preview:first-child .w3-card-0 img');
	let text = document.querySelector('#banners .preview:first-child .w3-card-0 .card-text');
	card.style.pointerEvents = "none"
	card0.style.backgroundImage = 'none';
	card0.style.boxShadow = 'none';
	img.style.boxShadow = 'none';
	more.style.display = 'none';
	text.style.top = '-200px';
	//text.style.position = "relative"
	//let ads = document.querySelector('#banners .ads');
	//card.prepend(ads)
}
...
<main class="">
	<div id="top-bar" class="w3-container w3-top" style="left: 0; right: 0;">
		<div id="bar" class="w3-bar w3-content">
			...
			<li><a on:click={() => handelLink("#home")} class="w3-bar-item w3-button w3-right w3-hide-small">Home</a></li>
			
			
			<li><a  on:click={() => handelLink("#banners")} class="w3-bar-item w3-button w3-right w3-hide-small">My Work</a>
			<ul>
				 
				<li><a  on:click={() => handelLink("#banners")} class="w3-bar-item w3-button w3-right w3-hide-small">Ads</a></li>
				<li><a on:click={() => handelLink("#work")} class="w3-bar-item w3-button w3-right w3-hide-small">Web</a></li>
			 
				<li><a  on:click={() => handelLink("#games")} class="w3-bar-item w3-button w3-right w3-hide-small">Games</a></li>

			</ul>
			</li>
			<li><a  on:click={() => handelLink("#resume")} class="w3-bar-item w3-button w3-right w3-hide-small">Resume</a></li>
			<li><a  on:click={() => handelLink("#who")} class="w3-bar-item w3-button w3-right w3-hide-small">Contact</a></li>
		...
		<!--	<li><a on:click={handelLink} use:scrollto={"#home"} class="w3-bar-item w3-button w3-right w3-hide-small">Home</a></li>
			...
			<ul>
				...
				<li><a  on:click={handelLink} use:scrollto={"#banners"} class="w3-bar-item w3-button w3-right w3-hide-small">Banners</a></li>
			</ul>
			</li>
	...
	<div id="navDemo" class="w3-top w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large" class:w3-show={showMobileMenu} style="margin-top: 65px;">
		<a  on:click={() => handelLink("#home")} class="w3-bar-item w3-button w3-right">Home</a>
		<a  on:click={() => handelLink("#banners")} class="w3-bar-item w3-button w3-right">Ads</a>
		<a  on:click={() => handelLink("#work")} class="w3-bar-item w3-button w3-right">Web</a>
		<a  on:click={() => handelLink("#games")} class="w3-bar-item w3-button w3-right">Games</a>
		<a  on:click={() => handelLink("#resume")} class="w3-bar-item w3-button w3-right">Resume</a>
		<a  on:click={() => handelLink("#who")} class="w3-bar-item w3-button w3-right">Contact</a>
<!---
	...
	<div id="banners" class="padding-64 w3-container">
		<div class="w3-content categories">
			<h2>Ads</h2>
		</div>

	<!--	<div class="w3-row ads w3-content">
			<h5>Show your product</h5>
			<p>Creation of video and still image templates for advertisements and publications.</p>
			<p>Thanks to the <a href="https://shotstack.io/">Shotstack.io</a> it is possible to have your publication in seconds</p>
			<p class="call-action"><a href="#who">Ask for more information</a></p>
		</div>
	-->
		<div class="row-container" transition:fade>
			<PreviewRow on:dipatchProject={handleClick} on:click={() => animateScroll.scrollToTop()}
				titleL='Show your product'
				descL='Creation of video and still image templates for advertisements and publications.'
				imageL='https://drive.google.com/uc?export=download&id=19XP-aBWurn4WRxuLQXpGNoSj6I-jh3OB'
				...
				titleM='Our Finest Chef'
				descM='Restaurant template. An agile way to display menu'
				imageM='https://drive.google.com/uc?export=download&id=1Dam84bLWnyY_1pVKacphi7RqwvrXeaVy'
				infoM="This template is suitable for promoting restaurants and their menus of the day. The template streamlines the process of creating videos in volume."
				serviceM="Flexible template to work with different services"
				adicionalM=""
				imageAM="https://drive.google.com/uc?export=download&id=1nMDTkYpqtIMXjZhUkaCS5XEcqRuf5jtk"
				imageBM="https://drive.google.com/uc?export=download&id=1muvCYQdhdJPpu12AgdtVrCgRR6P-emFr"
				imageCM="https://drive.google.com/uc?export=download&id=1ZHgHiqtbCXX_qBBt9aVfeOuhxGNXLAUp"
				imageDM="" 
				imageEM=""
				imageFM=""
				urlM="https://shotstack.io/templates/hotel-review-slideshow/"
	
				titleR='Make Your Reservation'
				descR='Hotel template with elegant transitions'
				imageR='https://drive.google.com/uc?export=download&id=1toWsDJ2m5v1MLLbiTPy7rnuy-B1ZZc4t'
				infoR="This template features a series of elegant transitions that bring a level of quality to the displayed product. The template streamlines the process of creating videos in volume."
				serviceR="Flexible template to work with different services"
				adicionalR=""
				imageAR="https://drive.google.com/uc?export=download&id=1zFhQYB5mDHmSmmHZ1guhlv9XXRPO1VHz"
				imageBR="https://drive.google.com/uc?export=download&id=1gD967MlFHY18Z2Y1vzO4Fn6rJSJBheDm"
				imageCR="https://drive.google.com/uc?export=download&id=1euKsXSgtYzIIhMyIPxyY9DQNLdYws8bO"
				imageDR="" 
				imageER=""
				imageFR="" 
				urlR="https://shotstack.io/templates/restaurant-monthly-specials-video/"
			></PreviewRow>
			</div>
	</div>
...
<!-- 
	...
	-->
		...
		titleR='PicaPez'
		descR='Catch as many fish as you can'
		imageR='https://drive.google.com/uc?export=download&id=1fJ6G1pSMbt8kVA__T9NEcaVGeAmQfKM1'
		infoR="Requirement-based casual gameplay"
		serviceR="The game was developed in Adobe Flash with Action Script."
		adicionalR="Game requires Flash plugin to run"
		imageAR="https://drive.google.com/uc?export=download&id=1AAE1a_L8iXiy1zgSc7eOq0QBJBkEBUX3"
		imageBR=""
		imageCR=""
		imageDR="" 
		imageER=""
		imageFR="" 
		urlR='https://pica-pez.netlify.app/'
	></PreviewRow>
		...
		<div class="w3-content categories">
			...
			<div class="w3-third" >
				...
				<p id="resume" class="resume">
					<a href="https://drive.google.com/uc?export=download&id=1gGZoUuZNkOTgDJwsb_-WeX1uo3Ey9L-8"><span class="material-symbols-outlined">
						picture_as_pdf
						</span> Resume_Miguel_Martinez.pdf <span class="material-symbols-outlined">
							download
							</span></a>
				</p>
			</div>
...
/* .scroll {
	...
	box-shadow: 2px -1px 19px -3px rgba(24,84,173, 0.3) !important;
 } */
...
background-image: radial-gradient(circle at bottom center, #277af610, #277af610 66%, transparent 66%), radial-gradient(circle at right 70%, #277af610, #277af610 10%, transparent 10%), radial-gradient(circle at left 20%, #277af610, #277af610 5%, transparent 5%); 
}
...
#banners .ads h5, #banners .ads a{
	font-weight: 700;
}

#banners .ads a, #banners .ads .call-action{
...
#navDemo {
	...
	box-shadow: 2px -1px 19px -3px rgba(24,84,173, 0.3);
}

#navDemo .w3-button:hover{
	background-color: #7aafff54 !important;
}
